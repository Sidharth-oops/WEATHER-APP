...
public class MainActivity extends AppCompatActivity {
    final String appid = "c80a6f5fb9763ee9f101d35845ab6a99";
  ...
  /*  protected void onResume() {
    ...
    updateUI(weatherData weather){
        ...
        int resoutceID=getResources().getIdentifier(weather.getMicon(),"drawable",getPackageName());
        mweatherIcon.setImageResource(resoutceID);
    }
